...
<h3 align="center">
  Front-end Finalizado - Go Barber
</h3>

<p align="center">Código do primeiro módulo do quinto nível <a href="https://rocketseat.com.br/bootcamp">Bootcamp GoStack</a> 🎓</p>
...
2. Entre na pasta rodando `cd bootcamp-gostack-exercicios/nivel-5/01-gobarber-front-end`;
3. Rode `yarn` para instalar as dependências;
4. Rode `yarn start` para iniciar o servidor.

Obs. para que a aplicação funcione por completo, tenha rodando também, o back-end e a database.
